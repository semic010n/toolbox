...
{
   private JTextField txtChangeTheFont; // used to display font changes
   ...
   public RadioButtonFrame()
   {
      ...
      txtChangeTheFont = new JTextField("Watch the font style change", 25);
      add(txtChangeTheFont); // add textField to JFrame
      ...
      txtChangeTheFont.setFont(plainFont);
